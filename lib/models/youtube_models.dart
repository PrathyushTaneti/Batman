class VideoYoutubeResults {
  String? nextPageToken;
  List<YoutubeVideo>? items;
  VideoYoutubeResults({this.nextPageToken, this.items});
  VideoYoutubeResults.fromJson(Map<String, dynamic> json) {
    nextPageToken = json['nextPageToken'];
    if (json['items'] != null) {
      items = <YoutubeVideo>[];
      json['items'].forEach((v) { items!.add(new YoutubeVideo.fromJson(v)); });
    }
  }
}
